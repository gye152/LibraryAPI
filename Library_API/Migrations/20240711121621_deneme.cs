    ...
    public partial class deneme : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LanguageBooks", x => new { x.LanguagesCode, x.BooksId });
                    table.ForeignKey(
                        name: "FK_LanguageBooks_Books_BooksId",
                        column: x => x.BooksId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LanguageBooks_Languages_LanguagesCode",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubCategoryBooks", x => new { x.SubCategoriesId, x.BooksId });
                    table.ForeignKey(
                        name: "FK_SubCategoryBooks_Books_BooksId",
                        column: x => x.BooksId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SubCategoryBooks_SubCategories_SubCategoriesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubCategoryBooks_BooksId",
