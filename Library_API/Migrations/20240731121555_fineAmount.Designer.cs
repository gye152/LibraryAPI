...
namespace Library_API.Migrations
{
    ...
    [Migration("20240731121555_fineAmount")]
    partial class fineAmount
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Library_API.Models.BookCopy", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Library_API.Models.Loan", b =>
                {
                    b.HasOne("Library_API.Models.BookCopy", "BookCopy")
                        .WithMany()
                        .HasForeignKey("BookCopiesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Library_API.Models.Employee", "Employee")
                        .WithMany()
